...
const utility: object = {
    ...
    wrapWithCodeWrapper(html: string, title: string | null, copy: boolean, code: string): string {
        const copyButtonHtml = `
            ...
            >
                <span x-show="!isCopied" class="[&>svg]:stroke-black dark:[&>svg]:stroke-white [&>svg]:w-5 [&>svg]:h-5 shrink-0">
                ...
                <span x-show="isCopied" x-cloak class="[&>svg]:stroke-black dark:[&>svg]:stroke-white [&>svg]:w-5 [&>svg]:h-5 shrink-0">
